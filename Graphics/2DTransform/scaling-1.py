...
mat2x2 = np.array([[0.5,0.0], [0.0,0.5]])

def draw(mat, col):
    pts = np.zeros((3,2))
    pts[0][0] = (mat[0][0] + 1) * SCREEN_WIDTH/2
    pts[0][1] = (-(mat[0][1] + 1) + 2.0) * SCREEN_HEIGHT/2
    pts[1][0] = (mat[1][0] + 1) * SCREEN_WIDTH/2
    pts[1][1] = (-(mat[1][1] + 1) + 2.0) * SCREEN_HEIGHT/2
    pts[2][0] = (mat[2][0] + 1) * SCREEN_WIDTH/2
    pts[2][1] = (-(mat[2][1] + 1) + 2.0) * SCREEN_HEIGHT/2
